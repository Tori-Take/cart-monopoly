...
export const BOARD: BoardSpace[] = [
  { index: 0, name: 'GO', type: 'go', icon: '←' },
  { index: 1, name: 'Mediterranean Avenue', type: 'street', price: 60, color: '#955436', group: 'brown', rents: [2, 10, 30, 90, 160, 250], houseCost: 50, mortgage: 30 },
  { index: 2, name: 'Community Chest', type: 'chest', icon: '◇' },
  { index: 3, name: 'Baltic Avenue', type: 'street', price: 60, color: '#955436', group: 'brown', rents: [4, 20, 60, 180, 320, 450], houseCost: 50, mortgage: 30 },
  { index: 4, name: 'Income Tax', type: 'tax', tax: 200, icon: '$' },
  { index: 5, name: 'Reading Railroad', type: 'railroad', price: 200, group: 'railroad', rents: [25, 50, 100, 200], mortgage: 100, icon: '■' },
  { index: 6, name: 'Oriental Avenue', type: 'street', price: 100, color: '#aae0fa', group: 'light-blue', rents: [6, 30, 90, 270, 400, 550], houseCost: 50, mortgage: 50 },
  { index: 7, name: 'Chance', type: 'chance', icon: '?' },
  { index: 8, name: 'Vermont Avenue', type: 'street', price: 100, color: '#aae0fa', group: 'light-blue', rents: [6, 30, 90, 270, 400, 550], houseCost: 50, mortgage: 50 },
  { index: 9, name: 'Connecticut Avenue', type: 'street', price: 120, color: '#aae0fa', group: 'light-blue', rents: [8, 40, 100, 300, 450, 600], houseCost: 50, mortgage: 60 },
  { index: 10, name: 'Jail / Just Visiting', type: 'jail', icon: '▦' },
  { index: 11, name: 'St. Charles Place', type: 'street', price: 140, color: '#d93d96', group: 'pink', rents: [10, 50, 150, 450, 625, 750], houseCost: 100, mortgage: 70 },
  { index: 12, name: 'Electric Company', type: 'utility', price: 150, group: 'utility', mortgage: 75, icon: '⚡' },
  { index: 13, name: 'States Avenue', type: 'street', price: 140, color: '#d93d96', group: 'pink', rents: [10, 50, 150, 450, 625, 750], houseCost: 100, mortgage: 70 },
  { index: 14, name: 'Virginia Avenue', type: 'street', price: 160, color: '#d93d96', group: 'pink', rents: [12, 60, 180, 500, 700, 900], houseCost: 100, mortgage: 80 },
  { index: 15, name: 'Pennsylvania Railroad', type: 'railroad', price: 200, group: 'railroad', rents: [25, 50, 100, 200], mortgage: 100, icon: '■' },
  { index: 16, name: 'St. James Place', type: 'street', price: 180, color: '#f7941d', group: 'orange', rents: [14, 70, 200, 550, 750, 950], houseCost: 100, mortgage: 90 },
  { index: 17, name: 'Community Chest', type: 'chest', icon: '◇' },
  { index: 18, name: 'Tennessee Avenue', type: 'street', price: 180, color: '#f7941d', group: 'orange', rents: [14, 70, 200, 550, 750, 950], houseCost: 100, mortgage: 90 },
  { index: 19, name: 'New York Avenue', type: 'street', price: 200, color: '#f7941d', group: 'orange', rents: [16, 80, 220, 600, 800, 1000], houseCost: 100, mortgage: 100 },
  { index: 20, name: 'Free Parking', type: 'parking', icon: 'P' },
  { index: 21, name: 'Kentucky Avenue', type: 'street', price: 220, color: '#ed1c24', group: 'red', rents: [18, 90, 250, 700, 875, 1050], houseCost: 150, mortgage: 110 },
  { index: 22, name: 'Chance', type: 'chance', icon: '?' },
  { index: 23, name: 'Indiana Avenue', type: 'street', price: 220, color: '#ed1c24', group: 'red', rents: [18, 90, 250, 700, 875, 1050], houseCost: 150, mortgage: 110 },
  { index: 24, name: 'Illinois Avenue', type: 'street', price: 240, color: '#ed1c24', group: 'red', rents: [20, 100, 300, 750, 925, 1100], houseCost: 150, mortgage: 120 },
  { index: 25, name: 'B. & O. Railroad', type: 'railroad', price: 200, group: 'railroad', rents: [25, 50, 100, 200], mortgage: 100, icon: '■' },
  { index: 26, name: 'Atlantic Avenue', type: 'street', price: 260, color: '#fef200', group: 'yellow', rents: [22, 110, 330, 800, 975, 1150], houseCost: 150, mortgage: 130 },
  { index: 27, name: 'Ventnor Avenue', type: 'street', price: 260, color: '#fef200', group: 'yellow', rents: [22, 110, 330, 800, 975, 1150], houseCost: 150, mortgage: 130 },
  { index: 28, name: 'Water Works', type: 'utility', price: 150, group: 'utility', mortgage: 75, icon: '●' },
  { index: 29, name: 'Marvin Gardens', type: 'street', price: 280, color: '#fef200', group: 'yellow', rents: [24, 120, 360, 850, 1025, 1200], houseCost: 150, mortgage: 140 },
  { index: 30, name: 'Go To Jail', type: 'go_to_jail', icon: '→' },
  { index: 31, name: 'Pacific Avenue', type: 'street', price: 300, color: '#1fb25a', group: 'green', rents: [26, 130, 390, 900, 1100, 1275], houseCost: 200, mortgage: 150 },
  { index: 32, name: 'North Carolina Avenue', type: 'street', price: 300, color: '#1fb25a', group: 'green', rents: [26, 130, 390, 900, 1100, 1275], houseCost: 200, mortgage: 150 },
  { index: 33, name: 'Community Chest', type: 'chest', icon: '◇' },
  { index: 34, name: 'Pennsylvania Avenue', type: 'street', price: 320, color: '#1fb25a', group: 'green', rents: [28, 150, 450, 1000, 1200, 1400], houseCost: 200, mortgage: 160 },
  { index: 35, name: 'Short Line', type: 'railroad', price: 200, group: 'railroad', rents: [25, 50, 100, 200], mortgage: 100, icon: '■' },
  { index: 36, name: 'Chance', type: 'chance', icon: '?' },
  { index: 37, name: 'Park Place', type: 'street', price: 350, color: '#0072bb', group: 'dark-blue', rents: [35, 175, 500, 1100, 1300, 1500], houseCost: 200, mortgage: 175 },
  { index: 38, name: 'Luxury Tax', type: 'tax', tax: 100, icon: '◆' },
  { index: 39, name: 'Boardwalk', type: 'street', price: 400, color: '#0072bb', group: 'dark-blue', rents: [50, 200, 600, 1400, 1700, 2000], houseCost: 200, mortgage: 200 },
]
